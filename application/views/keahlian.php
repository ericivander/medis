...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Keahlian</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    ?>
                    <a href="#" class="btn btn-primary data-modal" data-toggle="modal" data-target="#dataModal" data-key="0"><i class="fa fa-plus-square-o fa-fw"></i> Tambah Data Keahlian</a>
                    <br /><br />
